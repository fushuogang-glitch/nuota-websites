...
export const pricingPlans = [
  ...
  },
  {
    ...
    unit: '/年',
    monthly: '月均 ¥4,833',
    features: [`${AGENT_COUNT} 个 AI Agent`, '单店部署 + 数据中台', '高级数据分析看板', '投流分析闭环', '方法论知识库', '季度策略复盘'],
    cta: '立即咨询',
    recommended: true,
  },
  {
    ...
    unit: '/年',
    monthly: '月均 ¥8,167',
    features: ['多店统一管理', '跨店数据汇总', '连锁经营看板', '定制化配置', '专属客户成功经理', '月度策略陪跑'],
    cta: '联系我们',
    recommended: false,
  },
]
...
export const faqs = [
  {
    q: '需要购买硬件吗？',
    a: '不需要强制购买硬件。远程配置上线，只收年费；如涉及门店设备，可单独评估。',
  },
  {
    q: '上线周期多久？',
